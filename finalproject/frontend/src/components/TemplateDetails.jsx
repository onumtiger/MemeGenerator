...
export default class TemplateDetails extends React.Component {
    ...
    /**
     * update template statistics when component did mount
     */
    componentDidMount() {
    ...
    /**
     * update template statistics when component did update and the template is not the same as gthe previous template
     */
    componentDidUpdate() {
